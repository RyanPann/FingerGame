...
public class FingerGameServer {
	...
	public static void changeSelfWrite() {
		...
		if (l2_bool && r2_bool) {
			...
			String s;
			s = (String) JOptionPane.showInputDialog(null, "øÔæ‹ßA™∫§¿∞t:\n", "§¿∞t", JOptionPane.PLAIN_MESSAGE, null, obj,
					obj[0]);
			// ß‚s©Ó¶® var1 var2
